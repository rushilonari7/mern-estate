  ...
  <main className='p-3 max-w-4xl mx-auto'>
    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-col flex-1 gap-4 '>
            ...
            <button disabled={loading || uploading} className='p-3 text-white text-center bg-slate-700 rounded-lg uppercase
            hover:opacity-95 disable:opacity-80'>{loading?'Creating...':'Create Listing'}</button>
